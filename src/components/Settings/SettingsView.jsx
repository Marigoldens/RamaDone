...
import {
  ...
  Palette, Globe, Database, Settings as SettingsIcon,
              ...
              <section className="settings-card">
                ...
                <button
                  onClick={async () => {
                    ...
                    // Clear old prayer times so they regenerate with new coordinates
                    await db.events.where('type').anyOf('prayer', 'iftar').delete();
